        ...
        message =
          err.code === "ERR_NETWORK" || err.message === "Network Error"
            ? process.env.NODE_ENV === "development"
              ? "Cannot reach API. Start the backend (npm run dev in backend) and restart npm start. Dev proxy targets port 5000 by default; on macOS AirPlay may use 5000 — set PORT=5001 in backend/.env and REACT_APP_PROXY_TARGET=http://localhost:5001 in frontend/.env.development."
