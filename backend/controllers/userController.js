...
// @desc    Get a single user's public info by ID
...
module.exports = { registerUser, loginUser, getUserProfile, updateUserProfile, sendOtp, verifyOtp, getAllUsers, deleteUser, getUserById };
